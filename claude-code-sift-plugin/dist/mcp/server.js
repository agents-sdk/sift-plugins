...
import { PURGE_INTERVAL_MS, RETRIEVE_TOOL_NAME } from "../lib/config.js";
import { retrieveErrorText, retrieveFromSift, } from "../lib/retrieve.js";
import { claudeCodeStashRoot, SessionSiftStore, } from "../lib/session-store.js";
export const SIFT_RETRIEVE_DESCRIPTION = "Retrieve the full original tool output from the local sift stash. " +
...
const STASH_KEY_PARAMETER_DESCRIPTION = 'The stash key from the <<stash:KEY>> marker. Bare key (e.g. "0123456789abcdef01234567") or the full marker both work.';
 ...
 * original text.
 */
export function createScanningSift(root) {
    return {
        siftText() {
 ...
 */
export function createMcpCore(callRetrieve) {
